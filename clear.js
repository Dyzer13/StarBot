...
client.on('ready', () => {
    console.log(`~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~`);
    console.log(`Script By : !sD - jacky`);
    console.log(`~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~`);
    console.log(` Script By : !sD - jacky  `);
    console.log(`~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~`);
    console.log(`Logged in as  * [ " ${client.user.username} " ] servers! [ " ${client.guilds.size} " ]`);
    console.log(`~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~`);
    console.log(" MODE | YOLO! [ON]");
});
...
'*** اتصل على امك و قول لها انك تحبها :heart:. ***',
 ...
 if (message.content.startsWith(prefix + 'حكم')) {
  ...
  .setTitle("لعبة حكم ..")
  .setColor('RANDOM')
  .setDescription(`${JackyDev[Math.floor(Math.random() * JackyDev.length)]}`)
    ...
    if (message.content === prefix + 'add colors'){
        ...
        for(let x = 0; x < 110; x++){
            ...
            color: 'RANDOM'})
                ...
                message.channel.sendMessage('? **يلزمك رتبه اداريه لاجل تنفيذ الامر**')
            }
        }else{
            message.channel.sendMessage('?  **هذا الامر يستخدم فقط في السيرفر**')
        }
    }
...
client.on('message', message => {
    ...
    if(message.content.includes('youtube')){
        message.delete()
    return message.reply(`** لايمكنك نشر اروابط في هذا السيرفر **`)
    }
...
var prefix = "..";
  ...
  if (message.author.id == 315551239809138688) return;


if (message.content.startsWith(prefix + 'playing')) {
if (message.author.id !== '435154834497470475') return message.reply('** هذا الأمر فقط لصاحب البوت و شكراًً **')
...
if (message.content.startsWith("..add r")) {
             if(!message.channel.guild) return message.reply('**الامر متاح في السيرفر فقط**');
        if (!message.member.hasPermission('MANAGE_ROLES')) return message.reply('⚠ **لازمك برمشن اداريه حتى انفذ الامر المطلوب**');
        let args = message.content.split(" ").slice(1);
            message.guild.createRole({
                name : args.join(' '),
                color : "RANDOM", 
...
client.on("guildMemberAdd", (member) => {
    ...
    var guild;
    while (!guild)
        guild = client.guilds.find("name", " Wlc to Pro Clan")
...
client.on('message', msg => {
if (msg.content.includes('الله')) {
msg.reply(`الله اكبر`)
}
});
client.on('message', msg => {
if (msg.content.includes('انت')) {
msg.reply(`حمار`)
}
});
client.on('message', msg => {
if (msg.content.includes('الكلان')) {
msg.reply(`قصدك احلى كلان`)
}
});
client.on('message', msg => {
if (msg.content.includes('لاق')) {
msg.reply(`ابلع لاق`)
}
});
client.on('message', msg => {
if (msg.content.includes('يلعب')) {
msg.reply(`معي لاق والله`)
}
});
client.on('message', msg => {
if (msg.content.includes('كيفك')) {
...
client.on('message', msg => {
if (msg.content.includes('بزر')) {
msg.reply(`من جد يا بابا`)
}
});
client.on('message', msg => {
if (msg.content.includes('هاي')) {
msg.reply(`كول خره , وش هاي ذي`)
}
});
client.on('message', msg => {
if (msg.content.includes('عيال')) {
msg.reply(`سيد العيال انا`)
}
});
client.on('message', message => {
var prefix = ('..');
 if (message.content === (prefix) + "icon") {
   ...
   client.login('NDQ5NTkxOTA4OTE5MTQ4NTQ1.Dem9YA.AXb6Q9MmGMMGu6V9fptQUFGsSv0')